...
#Creamos redes poisson(3)

redes<-c("pois_100_1", "pois_100_2", "pois_100_3", "pois_500_1", "pois_500_2", "pois_500_3", 
         "pois_1000_1", "pois_1000_2", "pois_1000_3", "pois_10000_1", "pois_10000_2", 
         "pois_10000_3", "pois_50000_1", "pois_50000_2", "pois_50000_3")    
...
for(i in 1:15){
  ...
  #La función "local.network" se puede ver en "Funciones_Redes_LLRR.R"
  #distrib puede ser "fixed", "pois", "ztpois", "geom", "nbinom", "ztgeom", "poly.log", "watts.strogatz.game", 
     #"logarithmic", "power.law", "full" (completamente conectado) o "none" (ningun elemento conectado)
  #param es el parametro de la distribución
  ...
  assign(paste("coef", redes[i], sep = "_"),transitivity(get(paste("grafo", redes[i], sep = "_")),
        type="global")) #Coeficiente de agrupamiento medio de un red 
...
save(pois_100_1, pois_100_2, pois_100_3, pois_500_1, pois_500_2, pois_500_3, pois_1000_1, pois_1000_2, pois_1000_3, pois_10000_1, pois_10000_2, pois_10000_3, pois_50000_1, pois_50000_2, pois_50000_3,
     ...
     file="pois_5difnodos_15sim.RData") #aquí se guardan las 15 redes poisson y sus características
...
#creamos redes polylogaritmicas

redespoly<-c("poly_100_1", "poly_100_2", "poly_100_3", "poly_500_1", "poly_500_2", "poly_500_3", 
             "poly_1000_1", "poly_1000_2", "poly_1000_3", "poly_10000_1", "poly_10000_2", 
             "poly_10000_3", "poly_50000_1", "poly_50000_2", "poly_50000_3")    
nodos<-c(100, 500, 1000, 10000, 50000)
...
for(p in 1:15){
  ...
  assign(paste("coef", redespoly[p], sep = "_"),transitivity(get(paste("grafo", redespoly[p], sep = "_")),
        type="global")) #Coeficiente de agrupamiento medio de un red 
...
save(poly_100_1, poly_100_2, poly_100_3, poly_500_1, poly_500_2, poly_500_3, poly_1000_1, poly_1000_2, poly_1000_3, poly_10000_1, poly_10000_2, poly_10000_3, poly_50000_1, poly_50000_2, poly_50000_3,
     ...
     file="poly_5difnodos_15sim.RData") #aquí se guardan las 15 redes poly y sus características
save(redespoly, nodos, file="Redes y Nodos Poly.RData")


#############################################################################################

#creamos redes watts strongtz
...
save(ws_100_1, ws_100_2, ws_100_3, ws_500_1, ws_500_2, ws_500_3, ws_1000_1, ws_1000_2, ws_1000_3, ws_10000_1, ws_10000_2, ws_10000_3, ws_50000_1, ws_50000_2, ws_50000_3,
     ...
     file="WS_5difnodos_15sim.RData") #aquí se guardan las 15 redes ws y sus características
save(redesws, nodos, file="Redes y Nodos WS.RData")




#primero se habian considerado solo 5 caracteristicas de la red pero despues se calcularón dos más
...
# Distancia media 
mdist_pois_100_1<-mean_distance(grafo_pois_100_1)
mdist_pois_100_2<-mean_distance(grafo_pois_100_2)
mdist_pois_100_3<-mean_distance(grafo_pois_100_3)
mdist_pois_500_1<-mean_distance(grafo_pois_500_1)
mdist_pois_500_2<-mean_distance(grafo_pois_500_2)
mdist_pois_500_3<-mean_distance(grafo_pois_500_3)
mdist_pois_1000_1<-mean_distance(grafo_pois_1000_1)
mdist_pois_1000_2<-mean_distance(grafo_pois_1000_2)
mdist_pois_1000_3<-mean_distance(grafo_pois_1000_3)
mdist_pois_10000_1<-mean_distance(grafo_pois_10000_1)
mdist_pois_10000_2<-mean_distance(grafo_pois_10000_2)
mdist_pois_10000_3<-mean_distance(grafo_pois_10000_3)
mdist_pois_50000_1<-mean_distance(grafo_pois_50000_1)
mdist_pois_50000_2<-mean_distance(grafo_pois_50000_2)
mdist_pois_50000_3<-mean_distance(grafo_pois_50000_3)

mdist_poly_100_1<-mean_distance(grafo_poly_100_1)
mdist_poly_100_2<-mean_distance(grafo_poly_100_2)
mdist_poly_100_3<-mean_distance(grafo_poly_100_3)
mdist_poly_500_1<-mean_distance(grafo_poly_500_1)
mdist_poly_500_2<-mean_distance(grafo_poly_500_2)
mdist_poly_500_3<-mean_distance(grafo_poly_500_3)
mdist_poly_1000_1<-mean_distance(grafo_poly_1000_1)
mdist_poly_1000_2<-mean_distance(grafo_poly_1000_2)
mdist_poly_1000_3<-mean_distance(grafo_poly_1000_3)
mdist_poly_10000_1<-mean_distance(grafo_poly_10000_1)
mdist_poly_10000_2<-mean_distance(grafo_poly_10000_2)
mdist_poly_10000_3<-mean_distance(grafo_poly_10000_3)
mdist_poly_50000_1<-mean_distance(grafo_poly_50000_1)
mdist_poly_50000_2<-mean_distance(grafo_poly_50000_2)
mdist_poly_50000_3<-mean_distance(grafo_poly_50000_3)

mdist_ws_100_1<-mean_distance(grafo_ws_100_1)
mdist_ws_100_2<-mean_distance(grafo_ws_100_2)
mdist_ws_100_3<-mean_distance(grafo_ws_100_3)
mdist_ws_500_1<-mean_distance(grafo_ws_500_1)
mdist_ws_500_2<-mean_distance(grafo_ws_500_2)
mdist_ws_500_3<-mean_distance(grafo_ws_500_3)
mdist_ws_1000_1<-mean_distance(grafo_ws_1000_1)
mdist_ws_1000_2<-mean_distance(grafo_ws_1000_2)
mdist_ws_1000_3<-mean_distance(grafo_ws_1000_3)
mdist_ws_10000_1<-mean_distance(grafo_ws_10000_1)
mdist_ws_10000_2<-mean_distance(grafo_ws_10000_2)
mdist_ws_10000_3<-mean_distance(grafo_ws_10000_3)
mdist_ws_50000_1<-mean_distance(grafo_ws_50000_1)
mdist_ws_50000_2<-mean_distance(grafo_ws_50000_2)
mdist_ws_50000_3<-mean_distance(grafo_ws_50000_3)


# Distancia eigen centrality
eigen_pois_100_1<-eigen_centrality(grafo_pois_100_1)$value
eigen_pois_100_2<-eigen_centrality(grafo_pois_100_2)$value
eigen_pois_100_3<-eigen_centrality(grafo_pois_100_3)$value
eigen_pois_500_1<-eigen_centrality(grafo_pois_500_1)$value
eigen_pois_500_2<-eigen_centrality(grafo_pois_500_2)$value
eigen_pois_500_3<-eigen_centrality(grafo_pois_500_3)$value
eigen_pois_1000_1<-eigen_centrality(grafo_pois_1000_1)$value
eigen_pois_1000_2<-eigen_centrality(grafo_pois_1000_2)$value
eigen_pois_1000_3<-eigen_centrality(grafo_pois_1000_3)$value
eigen_pois_10000_1<-eigen_centrality(grafo_pois_10000_1)$value
eigen_pois_10000_2<-eigen_centrality(grafo_pois_10000_2)$value
eigen_pois_10000_3<-eigen_centrality(grafo_pois_10000_3)$value
eigen_pois_50000_1<-eigen_centrality(grafo_pois_50000_1)$value
eigen_pois_50000_2<-eigen_centrality(grafo_pois_50000_2)$value
eigen_pois_50000_3<-eigen_centrality(grafo_pois_50000_3)$value

eigen_poly_100_1<-eigen_centrality(grafo_poly_100_1)$value
eigen_poly_100_2<-eigen_centrality(grafo_poly_100_2)$value
eigen_poly_100_3<-eigen_centrality(grafo_poly_100_3)$value
eigen_poly_500_1<-eigen_centrality(grafo_poly_500_1)$value
eigen_poly_500_2<-eigen_centrality(grafo_poly_500_2)$value
eigen_poly_500_3<-eigen_centrality(grafo_poly_500_3)$value
eigen_poly_1000_1<-eigen_centrality(grafo_poly_1000_1)$value
eigen_poly_1000_2<-eigen_centrality(grafo_poly_1000_2)$value
eigen_poly_1000_3<-eigen_centrality(grafo_poly_1000_3)$value
eigen_poly_10000_1<-eigen_centrality(grafo_poly_10000_1)$value
eigen_poly_10000_2<-eigen_centrality(grafo_poly_10000_2)$value
eigen_poly_10000_3<-eigen_centrality(grafo_poly_10000_3)$value
eigen_poly_50000_1<-eigen_centrality(grafo_poly_50000_1)$value
eigen_poly_50000_2<-eigen_centrality(grafo_poly_50000_2)$value
eigen_poly_50000_3<-eigen_centrality(grafo_poly_50000_3)$value

eigen_ws_100_1<-eigen_centrality(grafo_ws_100_1)$value
eigen_ws_100_2<-eigen_centrality(grafo_ws_100_2)$value
eigen_ws_100_3<-eigen_centrality(grafo_ws_100_3)$value
eigen_ws_500_1<-eigen_centrality(grafo_ws_500_1)$value
eigen_ws_500_2<-eigen_centrality(grafo_ws_500_2)$value
eigen_ws_500_3<-eigen_centrality(grafo_ws_500_3)$value
eigen_ws_1000_1<-eigen_centrality(grafo_ws_1000_1)$value
eigen_ws_1000_2<-eigen_centrality(grafo_ws_1000_2)$value
eigen_ws_1000_3<-eigen_centrality(grafo_ws_1000_3)$value
eigen_ws_10000_1<-eigen_centrality(grafo_ws_10000_1)$value
eigen_ws_10000_2<-eigen_centrality(grafo_ws_10000_2)$value
eigen_ws_10000_3<-eigen_centrality(grafo_ws_10000_3)$value
eigen_ws_50000_1<-eigen_centrality(grafo_ws_50000_1)$value
eigen_ws_50000_2<-eigen_centrality(grafo_ws_50000_2)$value
eigen_ws_50000_3<-eigen_centrality(grafo_ws_50000_3)$value




save(mdist_pois_100_1,mdist_pois_100_2,mdist_pois_100_3,mdist_pois_500_1,mdist_pois_500_2,mdist_pois_500_3,mdist_pois_1000_1,mdist_pois_1000_2,mdist_pois_1000_3,mdist_pois_10000_1,mdist_pois_10000_2,mdist_pois_10000_3,mdist_pois_50000_1,mdist_pois_50000_2,mdist_pois_50000_3,
     mdist_poly_100_1,mdist_poly_100_2,mdist_poly_100_3,mdist_poly_500_1,mdist_poly_500_2,mdist_poly_500_3,mdist_poly_1000_1,mdist_poly_1000_2,mdist_poly_1000_3,mdist_poly_10000_1,mdist_poly_10000_2,mdist_poly_10000_3,mdist_poly_50000_1,mdist_poly_50000_2,mdist_poly_50000_3,
     mdist_ws_100_1,mdist_ws_100_2,mdist_ws_100_3,mdist_ws_500_1,mdist_ws_500_2,mdist_ws_500_3,mdist_ws_1000_1,mdist_ws_1000_2,mdist_ws_1000_3,mdist_ws_10000_1,mdist_ws_10000_2,mdist_ws_10000_3,mdist_ws_50000_1,mdist_ws_50000_2,mdist_ws_50000_3,
     eigen_pois_100_1,eigen_pois_100_2,eigen_pois_100_3,eigen_pois_500_1,eigen_pois_500_2,eigen_pois_500_3,eigen_pois_1000_1,eigen_pois_1000_2,eigen_pois_1000_3,eigen_pois_10000_1,eigen_pois_10000_2,eigen_pois_10000_3,eigen_pois_50000_1,eigen_pois_50000_2,eigen_pois_50000_3,
     eigen_poly_100_1,eigen_poly_100_2,eigen_poly_100_3,eigen_poly_500_1,eigen_poly_500_2,eigen_poly_500_3,eigen_poly_1000_1,eigen_poly_1000_2,eigen_poly_1000_3,eigen_poly_10000_1,eigen_poly_10000_2,eigen_poly_10000_3,eigen_poly_50000_1,eigen_poly_50000_2,eigen_poly_50000_3,
     eigen_ws_100_1,eigen_ws_100_2,eigen_ws_100_3,eigen_ws_500_1,eigen_ws_500_2,eigen_ws_500_3,eigen_ws_1000_1,eigen_ws_1000_2,eigen_ws_1000_3,eigen_ws_10000_1,eigen_ws_10000_2,eigen_ws_10000_3,eigen_ws_50000_1,eigen_ws_50000_2,eigen_ws_50000_3, 
     file="Cualidades de red, extra.RData")
